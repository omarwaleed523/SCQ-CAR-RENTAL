...
WebUI.click(findTestObject('Object Repository/Page_React App/label_0 - 29'))

WebUI.click(findTestObject('Object Repository/Page_React App/label_30 - 59'))

WebUI.click(findTestObject('Object Repository/Page_React App/label_60 - 99'))

WebUI.click(findTestObject('Object Repository/Page_React App/label_100 - 149'))

WebUI.click(findTestObject('Object Repository/Page_React App/label_150 - 199'))

WebUI.click(findTestObject('Object Repository/Page_React App/label_200'))
