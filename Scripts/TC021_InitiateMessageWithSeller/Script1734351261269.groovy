...
WebUI.click(findTestObject('Object Repository/Page_React App/a_LoginSignup'))
...
WebUI.click(findTestObject('Object Repository/Page_React App/button_Details'))

WebUI.click(findTestObject('Object Repository/Page_React App/p_SendMessage'))
