...
WebUI.click(findTestObject('Object Repository/Page_React App/input_Login_login_email'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_React App/input_Login_login_password'), 'bWwU7ycMudFLTyo9VBDQQg==')

WebUI.click(findTestObject('Object Repository/Page_React App/p_Login'))

WebUI.click(findTestObject('Object Repository/Page_React App/a_Rent'))

WebUI.click(findTestObject('Object Repository/Page_React App/label_SUV'))

WebUI.click(findTestObject('Object Repository/Page_React App/label_Sedan'))

WebUI.click(findTestObject('Object Repository/Page_React App/label_Sport'))
